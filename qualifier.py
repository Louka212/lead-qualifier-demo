...
def _system_prompt(business: dict) -> str:
    return (
        ...
        "- Plain text only: the chat bubble shows markdown literally, so no bold, bullets, or headers.\n"
        ...
        "- Once the visitor has answered one of the four, treat it as answered and move to the next "
        "one you don't have. Don't re-ask it in other words or offer option menus about it; a rough "
        "answer is enough, and nuance goes in the capture_lead summary.\n"
